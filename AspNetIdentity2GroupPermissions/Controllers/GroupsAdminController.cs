...
namespace IdentitySample.Controllers
{
    ...
    public class GroupsAdminController : Controller
    {
        ...
        public async Task<ActionResult> Create(
            [Bind(Include = "Name,Org,Description")] ApplicationGroup applicationgroup, params string[] selectedRoles)
        {
        ...
        public async Task<ActionResult> Edit(
            [Bind(Include = "Id,Name,Org,Description")] GroupViewModel model, params string[] selectedRoles)
        {
