...
namespace IdentitySample.Models
{
    ...
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            var smtp = new System.Net.Mail.SmtpClient("bss-unog-smtp02.unog.un.org");
            var mail = new System.Net.Mail.MailMessage();

            mail.IsBodyHtml = true;
            mail.From = new System.Net.Mail.MailAddress("no-reply@un-gdgs.ch", "GDGS");
            ...
            //smtp.Credentials = new NetworkCredential("ahid.manja@gmail.com", "ve7dkpgi0x");
            //var mail = new System.Net.Mail.MailMessage();
            //mail.IsBodyHtml = true;
            //mail.From = new System.Net.Mail.MailAddress("gdgssupport@unog.ch", "GDGS Confirmation");
            //mail.To.Add(message.Destination);
            //mail.Subject = message.Subject;
            //mail.Body = message.Body;
            //smtp.Timeout = 1000;
